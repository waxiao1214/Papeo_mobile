...
const Icon: React.FC<IconProps> = ({ name, size, color }) => {
  switch (name) {
    ...
    case 'close':
      return <CloseIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'male-on':
      return <ManOnIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'male-off':
      return <ManOffIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'female-on':
      return <FemaleOnIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'female-off':
      return <FemaleOffIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'gender-other-off':
      return <OtherOffIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'gender-other-on':
      return <OtherOnIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'camera':
      return <CameraIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'camera-front':
      return <CameraFrontIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'gallery':
      return <GalleryIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'warning':
      return <Warning width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'verify':
      return <VerifiedIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'location-me':
      return <CurrentLocationIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'private':
      return <PrivateIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'commercial':
      return <CommercialIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'lock-on':
      return <LockOnIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'lock-off':
      return <LockOffIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'free':
      return <FreeIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'guy':
      return <GuyIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    case 'upload':
      return <UploadImageIcon width={size || DEFAULT_ICON_SIZE} height={size || DEFAULT_ICON_SIZE} color={color || DEFAULT_ICON_COLOR} />;
    default:
      return null 
  }
};
